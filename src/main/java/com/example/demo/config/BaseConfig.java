...
public abstract class BaseConfig {
	...
	public FlatFileItemReader<Employee> csvReader() {
		...
		// ファイル読み込み設定
		return new FlatFileItemReaderBuilder<Employee>() // Builder作成
	...
	public BeanValidatingItemProcessor<Employee> validationProcessor() {
		...
		// true: skip バリデーションエラーが発生したデータはスキップする。つまりバッチは停止せずに次のデータを処理する。
		// false: throw ValidationException
		// バリデーションエラーが発生したらValidationExceptionが発生。つまりバッチが途中で停止する。
